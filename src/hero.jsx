...
const Hero = () => {
    ...
    return(
        <div id="hero" className="w-screen h-screen bg-cover bg-center bg-no-repeat flex flex-col relative mb-10" style={{backgroundImage:'url(./heroBg.jpg)'}}>
            ...
            <div className="w-[100%] h-[90%] flex flex-col justify-center lg:items-start items-center lg:pl-10"> 
                ...
                <div className="w-[88%] h-[72%] md:h-[50%] lg:w-[40%] lg:h-[60%] flex flex-col items-center justify-center p-5 border-1 rounded-3xl bg-white pt-5">
                    ...
                    <h1 className="text-[15px] lg:text-2xl font-bold text-black mb-1 md:mb-6 lg:mb-5">{`we offer - ${text}`}</h1>
                    ...
                    <p className="text-[15px] md:text-[1rem] lg:text-[20px] text-black md:font-bold text-center leading-[18px] md:leading-8 lg:leading-8">
