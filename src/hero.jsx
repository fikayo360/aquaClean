    ...
    return(
        <div id="hero" className="w-screen h-screen bg-cover bg-center bg-no-repeat flex flex-col relative" style={{backgroundImage:'url(./heroBg.jpg)'}}>
            ...
            <div className="w-[100%] h-[90%] flex flex-col justify-center lg:items-start items-center lg:pl-10"> 
                ...
                <div className="w-[80%] h-[75%] md:h-[60%] lg:w-[40%] lg:h-[60%] flex flex-col items-center p-5 border-1 rounded-3xl bg-white pt-5">
                    <h1 ref={ref} className={`text-3xl lg:text-5xl font-bold text-black uppercase mb-2 md:mb-8 lg:mb-8 ${inView?'animate__shakeX':''}`}>Aqua-Clean</h1>
                    <h1 className="text-[1rem] lg:text-2xl font-bold text-black mb-2 md:mb-8 lg:mb-5">{`we offer - ${text}`}</h1>
                    <h1 className="text-[16px]  md:text-[1.1rem] lg:text-2xl text-black text-center font-bold mb-4 lg:mb-5">We provide top-notch janitorial services that will make your space shine</h1>
                    <p className="text-[17px] md:text-[1.1rem] lg:text-[20px] text-black md:font-bold text-center leading-7 md:leading-10 lg:leading-8">
