        ...
        <div id="hero" className="w-screen h-screen bg-cover bg-center bg-no-repeat flex flex-col relative" style={{backgroundImage:'url(./heroBg.jpg)'}}>
            ...
            <div className="w-[100%] h-[90%] flex flex-col justify-center lg:items-start items-center lg:pl-10"> 
                ...
                <div className="w-[80%] h-[70%] md:h-[50%] lg:w-[40%] lg:h-[60%] flex flex-col items-center justify-center p-5 border-1 rounded-3xl bg-white pt-5">
                    ...
                    <h1 className="text-[15px]  md:text-[1rem] lg:text-2xl text-black text-center font-bold mb-3 lg:mb-5">We provide top-notch janitorial services that will make your space shine</h1>
