    ...
    return(
        <div id="hero" className="w-screen h-screen bg-cover  bg-center bg-no-repeat flex flex-col relative mb-[4rem] overflow-hidden" style={{backgroundImage:'url(./heroBg.jpg)'}}>
            ...
            <div className="w-[100%] h-[90%] flex flex-col justify-center lg:items-start items-center lg:pl-10"> 
                ...
                <div className="w-[88%] h-[70%] md:h-[58%] lg:w-[44%] lg:h-[60%] flex flex-col items-center justify-center p-5 border-1 rounded-3xl bg-[#190E4F] pt-5">
                    <h1 ref={ref} className={`text-3xl lg:text-3xl font-bold text-[#ecf2f9] uppercase mb-4 md:mb-6 lg:mb-6 ${inView?'animate__animated animate__rubberBand':''}`}>Aqua-Clean</h1>
                    ...
                    <p className="text-[13px] md:text-[1rem] lg:text-[1rem] text-[#ecf2f9] text-center leading-[2rem] md:leading-[3rem] lg:leading-7 xl:leading-8 2xl:leading-9">
