const Team = () => {
    return (
        <div id="team" className="w-screen h-screen flex justify-center items-center  bg-cover bg-center bg-no-repeat bg-blend-darken overflow-hidden" style={{backgroundImage:'url(./team.jpg)'}} >
            ...
            <div className=" w-[80%] h-[68%] md:h-[54%] lg:w-[50%] lg:h-[45%] flex flex-col p-10 border-1 rounded-3xl bg-white ">
                ...
                <p className="text-[13px] text-black leading-[20px] text-center md:text-start md:leading-[3.2rem] lg:leading-[3.5rem] font-mont">
