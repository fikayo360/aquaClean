const Team = () => {
    return (
        <div id="team" className="w-screen h-screen flex justify-center items-center  bg-cover bg-center bg-no-repeat bg-blend-darken mb-[7rem]" style={{backgroundImage:'url(./team.jpg)'}} >
