const Team = () => {
    return (
        <div id="team" className="w-screen h-screen flex justify-center items-center  bg-cover bg-center bg-no-repeat bg-blend-darken " style={{backgroundImage:'url(./team.jpg)'}} >
            ...
            <div className=" w-[80%] h-[70%] md:h-[50%] lg:w-[50%] lg:h-[48%] flex flex-col p-10 border-1 rounded-3xl bg-white ">
                ...
                <p className="text-1xl text-black leading-[1.20rem] md:leading-8 lg:leading-10 font-mont">
