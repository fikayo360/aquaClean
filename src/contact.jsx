            ...
            relative overflow-scroll">
                ...
                <div className="w-[100%] h-[80%] flex gap-10 flex-col items-center">
                    ...
                    <form className="flex flex-col w-[100%] h-[78%] gap-5 items-center justify-center">
                        ...
                        <button className="w-[60%] lg:w-[40%] h-[2.8rem] lg:[h-4rem] rounded-md bg-green-600 font-bold hover:text-slate-600 text-white text-[13px] lg:text-[1.2rem] flex items-center justify-center font-pop">Send</button>
                    </form>
