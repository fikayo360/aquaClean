const Contact = () => {
    return (
        <div id="contact" className="w-screen h-[100vh] md:h-screen bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center absolute overflow-hidden " style={{backgroundImage:'url(./contact.jpg)'}}>
