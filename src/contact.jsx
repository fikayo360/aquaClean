const Contact = () => {
    return (
        <div id="contact" className="w-screen h-[150vh] md:h-screen bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center relative   overflow-scroll" style={{backgroundImage:'url(./contact.jpg)'}}>

            <div  className="flex w-[80%] h-[60%] md:w-[60%] md:h-[73%] flex-col items-center justify-center border-1 rounded-3xl bg-white relative ">
